...
export const initialAlarms: Alarm[] = [
  ...
  },
  {
    ...
    notifyTime: now.subtract(8, 'minute').format('YYYY-MM-DD HH:mm:ss'),
  ...
  },
  {
    ...
    notifyTime: now.subtract(22, 'hour').subtract(55, 'minute').format('YYYY-MM-DD HH:mm:ss'),
    arriveTime: now.subtract(22, 'hour').subtract(40, 'minute').format('YYYY-MM-DD HH:mm:ss'),
    disposeTime: now.subtract(22, 'hour').subtract(10, 'minute').format('YYYY-MM-DD HH:mm:ss'),
    reviewTime: now.subtract(22, 'hour').format('YYYY-MM-DD HH:mm:ss'),
    archiveTime: now.subtract(21, 'hour').subtract(50, 'minute').format('YYYY-MM-DD HH:mm:ss'),
...
export const drillRecords: DrillRecord[] = [
  {
    id: 'DR001',
    name: '2026年上半年消防演练',
    date: now.subtract(15, 'day').format('YYYY-MM-DD'),
    duration: 90,
    participants: ['张三', '李四', '王五', '安保队全体'],
    videoUrl: '',
    description: '模拟高层火灾应急疏散演练',
    result: 'good',
    events: [
      { id: 'E001', name: '演练开始', description: '总指挥宣布演练开始', timeOffset: 0, completed: true },
      { id: 'E002', name: '火灾报警', description: '3层烟感探测器触发报警', timeOffset: 5, completed: true },
      { id: 'E003', name: '值班确认', description: '值班人员接警并确认火情', timeOffset: 7, completed: true },
      { id: 'E004', name: '应急预案启动', description: '启动火灾应急预案，通知各部门', timeOffset: 10, completed: true },
      { id: 'E005', name: '人员疏散', description: '各楼层人员开始疏散', timeOffset: 15, completed: true },
      { id: 'E006', name: '消防设施启动', description: '消防水泵、排烟设备自动启动', timeOffset: 20, completed: true },
      { id: 'E007', name: '消防员抵达', description: '消防队抵达现场并展开救援', timeOffset: 35, completed: true },
      { id: 'E008', name: '伤员救治', description: '医疗人员对伤员进行紧急救治', timeOffset: 50, completed: true },
      { id: 'E009', name: '人员清点', description: '在集合点清点疏散人数', timeOffset: 70, completed: true },
      { id: 'E010', name: '演练结束', description: '总指挥宣布演练结束并总结', timeOffset: 90, completed: true },
    ],
  },
  {
    id: 'DR002',
    name: '消防水泵联动测试',
    date: now.subtract(45, 'day').format('YYYY-MM-DD'),
    duration: 60,
    participants: ['工程部', '安保部'],
    videoUrl: '',
    description: '消防水泵自动启动测试',
    result: 'excellent',
    events: [
      { id: 'E011', name: '测试准备', description: '检查设备状态，准备测试', timeOffset: 0, completed: true },
      { id: 'E012', name: '触发信号', description: '发送消防水泵启动信号', timeOffset: 5, completed: true },
      { id: 'E013', name: '水泵启动', description: '1号消防水泵自动启动', timeOffset: 8, completed: true },
      { id: 'E014', name: '压力检测', description: '检测管网压力是否达标', timeOffset: 15, completed: true },
      { id: 'E015', name: '流量检测', description: '检测水泵出水流量', timeOffset: 25, completed: true },
      { id: 'E016', name: '备用水泵切换', description: '测试2号备用水泵自动切换', timeOffset: 35, completed: true },
      { id: 'E017', name: '联动测试', description: '与报警系统联动测试', timeOffset: 45, completed: true },
      { id: 'E018', name: '测试完成', description: '所有测试项目通过', timeOffset: 60, completed: true },
    ],
  },
  {
    id: 'DR003',
    name: '应急照明演练',
    date: now.subtract(75, 'day').format('YYYY-MM-DD'),
    duration: 30,
    participants: ['全体值班人员'],
    videoUrl: '',
    description: '断电情况下应急照明切换测试',
    result: 'excellent',
    events: [
      { id: 'E021', name: '演练开始', description: '模拟突发断电情况', timeOffset: 0, completed: true },
      { id: 'E022', name: '主电切断', description: '切断正常照明电源', timeOffset: 2, completed: true },
      { id: 'E023', name: '应急照明启动', description: '应急照明自动点亮', timeOffset: 3, completed: true },
      { id: 'E024', name: '疏散指示检查', description: '检查疏散指示标志是否正常', timeOffset: 10, completed: true },
      { id: 'E025', name: '持续时间测试', description: '测试应急照明持续时间', timeOffset: 20, completed: true },
      { id: 'E026', name: '主电恢复', description: '恢复主电源供应', timeOffset: 25, completed: true },
      { id: 'E027', name: '演练结束', description: '应急照明切换功能正常', timeOffset: 30, completed: true },
    ],
  },
];
